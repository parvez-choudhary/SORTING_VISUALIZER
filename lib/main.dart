        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Expanded(child: FlatButton(onPressed: isSorting ? null : _sort, child: Text("SORT",style: TextStyle(color: Colors.white)))),
              Expanded(
                  child: FlatButton(
...
class BarPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (this.value < 500 * .10) {
      paint.color = Color(0xFFFF8A80);
    } else if (this.value < 500 * .20) {
      paint.color = Color(0xFFFFD180);
    } else if (this.value < 500 * .30) {
      paint.color = Color(0xFFFFFF8D);
    } else if (this.value < 500 * .40) {
      paint.color = Color(0xFFB9F6CA);
    } else if (this.value < 500 * .50) {
      paint.color = Color(0xFF82B1FF);
    } else if (this.value < 500 * .60) {
      paint.color = Color(0xFF8C9EFF);
    } else if (this.value < 500 * .70) {
      paint.color = Color(0xFFB388FF);
    } else if (this.value < 500 * .80) {
      paint.color = Color(0xFFCFD8DC);
    } else if (this.value < 500 * .90) {
      paint.color = Color(0xFF82B1FF);
    } else {
      paint.color = Color(0xFFFF9E80);
    }
